import { Search, MailOutline, Notifications } from '@mui/icons-material'
    ...
    <nav className="navbar">
      ...
      <div className="right">
        ...
        <div className="user">
          <img
            className="avatar"
            src="https://images.pexels.com/photos/1961183/pexels-photo-1961183.jpeg?auto=compress&cs=tinysrgb&w=400"
            alt=""
          />
          <span>CHU Ferdinand</span>
        </div>
      </div>
    </nav>
  )
